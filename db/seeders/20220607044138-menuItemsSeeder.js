  ...
  up: (queryInterface, Sequelize) => {
    ...
    */
    return queryInterface.bulkInsert('MenuItems', [
      ...
      { name: 'Double Krabby Patty', description: 'Twice the MEEEAAAT!', restaurantId: 1, image: 'https://static.wikia.nocookie.net/spongebob/images/9/9b/Deluxe_Krabby_Patty.jpg', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Corral Bits', description: 'Just the right amount of crunch', restaurantId: 1, image: 'https://static.wikia.nocookie.net/spongebob/images/7/7e/Coral_Bits_HD.PNG', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Krusty Krab Pizza', description: 'The Krusty Krab Pizza, is the pizza, for you and me!', restaurantId: 1, image: 'https://static.wikia.nocookie.net/spongebob/images/e/e4/Pizza_Delivery_136.png', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Pretty Patty', description: 'A krabby patty, but prettier!', restaurantId: 1, image: 'https://static.wikia.nocookie.net/spongebob/images/9/9a/Patty_Hype_056.png', createdAt: new Date(), updatedAt: new Date() },
      ...
      { name: 'Chum stick', description: 'Bleh.', restaurantId: 2, image: 'https://static.wikia.nocookie.net/spongebob/images/d/da/Chum_stick_model_pose.jpg', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Chumbalaya', description: 'Gross', restaurantId: 2, image: 'https://static.wikia.nocookie.net/spongebob/images/6/68/Chumbalaya.png', createdAt: new Date(), updatedAt: new Date() },
      ...
      { name: 'Pepperoni Pizza', description: 'The classic pizza', restaurantId: 7, image: 'https://static.wikia.nocookie.net/cafeworld/images/6/6e/Pepperonipizza.png', createdAt: new Date(), updatedAt: new Date() },
    ], {});
  },
