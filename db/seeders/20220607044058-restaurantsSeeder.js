  ...
  up: (queryInterface, Sequelize) => {
    ...
    */
    return queryInterface.bulkInsert('Restaurants', [
      { name: 'Krusty Krab', description: 'The Krusty Krab, owned by Mr. Eugene Krabs, is home to the world famous Krabby Patty', ownerId: 2, restaurantShelfId: 1, image: '../images/Krusty_Krab.png', createdAt: new Date(), updatedAt: new Date() },
